...
util_redcap_child_v3 <- function(data) {
  ...
  # fix names
  names(visit_data_child)[names(visit_data_child) == 'v3_checklist_notes'] <- 'v3_pre_notes'
  names(visit_data_child)[names(visit_data_child) == 'v3_checklist_notes_post'] <- 'v3_notes'
