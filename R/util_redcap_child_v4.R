...
#' \itemize{
#'  \item{clean raw child visit 4 datasets}
...
util_redcap_child_v4 <- function(data) {
  ...
  # fix names
  names(visit_data_child)[names(visit_data_child) == 'v4_checklist_notes'] <- 'v4_pre_notes'
  names(visit_data_child)[names(visit_data_child) == 'v4_checklist_notes_post'] <- 'v4_notes'
  ...
  names(visit_data_child)[names(visit_data_child) == 'grapes_notes_1'] <- 'premeal_grapes_notes'
  names(visit_data_child)[names(visit_data_child) == 'carrots_post_notes2'] <- 'postmeal_carrots2_notes'


  # reorder
  visit_data_child <- visit_data_child[c('participant_id', 'visit_protocol', 'visit_date', names(visit_data_child)[grepl('^v4', names(visit_data_child))], names(visit_data_child)[grepl('preload', names(visit_data_child))], names(visit_data_child)[grepl('meal', names(visit_data_child))], names(visit_data_child)[grepl('child|rsa_notes$', names(visit_data_child))])]
