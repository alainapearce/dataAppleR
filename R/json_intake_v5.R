...
json_intake_v5 <- function() {
  ...
  intake_list_v5 <- list(
    ...
    mac_pre_w_plate = list( Description = 'Total pre-meal weight of macaroni and cheese with plate for all servings',
                                  Unit = "grams"),
    mac_post_w_plate = list( Description = 'Total post-meal weight of macaroni and cheese with plate for all servings',
                                   Unit = "grams"),
    ...
    broccoli_pre_w_plate = list( Description = 'Total pre-meal weight of broccoli with plate for all servings',
                            Unit = "grams"),
    broccoli_post_w_plate = list( Description = 'Total post-meal weight of broccoli with plate for all servings',
                             Unit = "grams"),
    ...
    grapes_pre_w_plate = list( Description = 'Total pre-meal weight of grapes with plate for all servings',
                            Unit = "grams"),
    grapes_post_w_plate = list( Description = 'Total post-meal weight of grapes with plate for all servings',
                             Unit = "grams"),
    ...
    carrots_pre_w_plate = list( Description = 'Total pre-meal weight of carrots with plate for all servings',
                            Unit = "grams"),
    carrots_post_w_plate = list( Description = 'Total post-meal weight of carrots with plate for all servings',
                             Unit = "grams"),
    ...
    graham_pre_w_plate = list( Description = 'Total pre-meal weight of graham cracker with plate for all servings',
                            Unit = "grams"),
    graham_post_w_plate = list( Description = 'Total post-meal weight of graham cracker with plate for all servings',
                             Unit = "grams"),
